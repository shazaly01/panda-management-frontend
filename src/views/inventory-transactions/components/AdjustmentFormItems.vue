<template>
  ...
  >
    <div class="flex justify-between items-center mb-4">
      <h3 class="text-lg font-bold text-gray-800 dark:text-white">الأصناف المشمولة في التسوية</h3>
      <button
        type="button"
        @click="addRow"
        class="flex items-center gap-1 bg-amber-50 text-amber-600 px-3 py-2 rounded-lg hover:bg-amber-100 transition-colors text-sm font-semibold"
      >
        <svg
    ...
    <div class="overflow-x-auto">
      <table class="w-full text-sm text-right">
        ...
        >
          <tr>
            <th scope="col" class="px-3 py-3 w-2/5">الصنف</th>
            <th scope="col" class="px-3 py-3 w-1/4">الوحدة</th>
            <th scope="col" class="px-3 py-3 w-1/4">الكمية (العجز / الزيادة)</th>
          ...
          >
            ...
            <td class="p-2">
              <input
                ...
                class="w-full p-2 border border-gray-300 rounded-md focus:ring-amber-500 focus:border-amber-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
              />
