...
const deleteSelectedUser = async () => {
  if (userToDelete.value) {
    try {
      ...
      // لا نحتاج لـ fetch هنا لأن الـ store يقوم بالفلترة محلياً إذا كان مبرمجاً لذلك،
      // أو يتم الاعتماد على استجابة الـ Store.
      ...
      isDeleteDialogOpen.value = false // تأكد من إغلاق المودال بعد الحذف
    }
  }
}
</script>
