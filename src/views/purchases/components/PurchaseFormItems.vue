<template>
  ...
  >
    <div
      class="mb-8 p-5 bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-gray-800 dark:to-gray-800/80 rounded-xl border border-emerald-100/50 dark:border-gray-700 shadow-inner"
    >
      <label
        class="flex items-center text-sm font-bold text-emerald-900 dark:text-emerald-300 mb-3"
      >
        <svg
        ...
        إضافة صنف سريع لفاتورة المشتريات (ابحث بالاسم أو مرر الباركود)
      </label>
      ...
      <table class="w-full text-sm text-right bg-white dark:bg-gray-800">
        ...
        >
          <tr
            ...
            class="hover:bg-emerald-50/30 dark:hover:bg-gray-700/30 transition-all duration-200 group"
          >
            <td class="px-4 py-3 align-middle">
              <div v-if="row.item_id" class="flex flex-col">
                ...
                <span class="text-xs text-emerald-500 font-mono mt-0.5">
                  ID: {{ row.item_id }}
                </span>
              </div>
            ...
            <td class="px-2 py-2 align-middle">
              <div class="relative">
                <UnitsDropdown
                  ...
                  v-model="row.unit_id"
                  :show-label="false"
                  class="w-full bg-transparent border-0 border-b border-transparent hover:border-gray-300 focus:ring-0 focus:border-emerald-500 p-1 text-sm transition-colors"
                />
              </div>
            ...
            <td class="px-2 py-2 align-middle">
              <input
                ...
                class="w-full p-2 text-center font-bold text-gray-900 dark:text-white bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all shadow-sm"
              />
            ...
            <td class="px-2 py-2 align-middle">
              <input
                ...
                class="w-full p-2 text-left font-bold text-gray-900 dark:text-white bg-transparent border border-transparent hover:border-gray-200 focus:border-emerald-500 focus:bg-white dark:focus:bg-gray-800 rounded-lg transition-all"
                dir="ltr"
              />
              <p v-if="errors[`price_${index}`]" class="text-rose-500 text-xs mt-1 text-center">
                خطأ
              </p>
            </td>
    ...
    >
      ...
      يجب إضافة صنف واحد على الأقل لفاتورة المشتريات لتتمكن من الحفظ.
    </p>
  </div>
</template>
...
// 🌟 تطابق تام مع المبيعات: تمت إضافة item_name و item_code لتخزين بيانات الصنف في السطر
